...
<div class="inner-header">
	...
	<div class="container">
		<div id="content">
			...
			<form action="{{ route('pages.postDatHang') }}" method="post" class="beta-form-checkout">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									@foreach($product_cart as $value)
										<div class="media">
											<img width="25%" src="source/image/product/{{ $value['item']['image'] }}" alt="{{ $value['item']['name'] }}" class="pull-left">
